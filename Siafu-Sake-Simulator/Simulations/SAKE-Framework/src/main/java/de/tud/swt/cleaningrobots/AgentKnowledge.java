...
public class AgentKnowledge {
	...
	/**
	 * Set the information about the last arrange of two agents.
	 * @param lastArrange
	 */
	...
	/**
	 * Set the last destination the agent moves to.
	...
	/**
	 * Set the hardware components the agents has with string values.
	 * @param components
	 */
	...
	/**
	 * Set a list of states the other agent is interested in.
	 * @param knownStates
	 */
	...
	/**
	 * Set the roles the other agent plays.
	 * @param roles
	 */
