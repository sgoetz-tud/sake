 ...
 * 
 */
public class SiafuPosition extends Position implements Serializable, Comparable<SiafuPosition>,
		Publishable {
	/**
	 ...
	 *            corner of the provided background map
	 */
	public static void initialize(final SiafuWorld worldObj,
	 ...
	 */
	public SiafuPosition(final int i, final int j)
			throws PositionOutOfTheMapException {
		if (!initialized) {
	 ...
	 */
	public SiafuPosition(final double lat, final double lon)
			throws PositionOutOfTheMapException {
	 ...
	 */
	public SiafuPosition(final SiafuPosition p) throws PositionOutOfTheMapException {
		this(p.i, p.j);
	}
	 ...
	 */
	public SiafuPosition(final String str) throws NumberFormatException,
	 ...
	 */
	public SiafuPosition(final FlatData flatData) {
		...
		SiafuPosition pos = coordinateTools.coordinatesToLocal(lat, lon);
		this.i = pos.i;
		this.j = pos.j;
	}
	 ...
	 */
	public SiafuPosition calculateMove(final int rawDir)
			throws PositionOnAWallException {
		int dir = ((rawDir % DIRECTIONS) + DIRECTIONS) % DIRECTIONS;

		SiafuPosition p = new SiafuPosition(this.i + COMPASS[dir][0], this.j
				+ COMPASS[dir][1]);
	...
	public boolean equals(final Object o) {
		if (o instanceof SiafuPosition) {
			SiafuPosition p = (SiafuPosition) o;
	 ...
	 */
	public int compareTo(final SiafuPosition p) {
		if (p.i > i) {
			return -1;
		} else if (p.i < i) {
			return 1;
	 ...
	 */
	public boolean isNear(final SiafuPosition pos) {
	 ...
	 * @return true if the positions are near each other
	 */
	public boolean isNear(final SiafuPosition pos, final int radius) {
	 ...
	 * Position object.
	 * 
	 * @see CoordinateTools#localToCoordinates(SiafuPosition)
