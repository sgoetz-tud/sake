 ...
 * <ul>
 *   <li>{@link cleaningrobots.impl.StateImpl#getName <em>Name</em>}</li>
 *   <li>{@link cleaningrobots.impl.StateImpl#getTransition <em>Transition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends MinimalEObjectImpl.Container implements State {
	...
	protected EClass eStaticClass() {
		return CleaningrobotsPackage.Literals.STATE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CleaningrobotsPackage.STATE__NAME, oldName, name));
	}
	...
	public EList<State> getTransition() {
		if (transition == null) {
			transition = new EObjectResolvingEList<State>(State.class, this, CleaningrobotsPackage.STATE__TRANSITION);
		}
		return transition;
	}
